...
const WhyChoose = () => {
  const advantages = [
    ...
    },
    {
      icon: Clock,
      title: "Fast Delivery",
      description: "Agile methodology ensures rapid development cycles without compromising on quality."
    },
    {
      icon: Users,
    ...
    },
    {
      icon: Globe,
      title: "Global Reach",
      description: "Serving clients worldwide with round-the-clock support and communication."
    }
  ];
      ...
      <div className="container mx-auto px-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {advantages.map((advantage, index) => (
            <Card key={advantage.title} className="group text-center hover:shadow-elegant transition-all duration-500 border-border/50 hover:border-accent/20 animate-fade-in-up" style={{ animationDelay: `${index * 0.1}s` }}>
